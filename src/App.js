...
class App extends Component {
  ...
  componentDidMount() {
    fetch("https://ancient-sea-90042.herokuapp.com/").then((res) =>
      console.log(res)
    );
  }
  ...
  onButtonSubmit = () => {
    ...
    //also trigger render
    fetch("https://ancient-sea-90042.herokuapp.com//imageurl", {
      ...
      .then((response) => {
        ...
        fetch(`https://ancient-sea-90042.herokuapp.com//image`, {
          method: "put",
          headers: { "Content-type": "application/json" },
          body: JSON.stringify({
